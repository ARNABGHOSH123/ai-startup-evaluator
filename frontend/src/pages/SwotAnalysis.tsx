  ...
  const sections = [
    {
      ...
      title: "Strengths",
      body: data.strengths,
      color: "text-cardgreen",
      bgColor: "bg-cardgreenlight",
      icon: <Star size={14} />,
    },
    {
      id: "weaknesses",
      ...
      color: "text-cardorange",
      bgColor: "bg-cardorangelight",
      icon: <Bolt size={14} />,
    },
    {
      id: "opportunities",
      ...
      <CardContent className="space-y-2 -mt-3">
        {sections.map((s) => (
          ...
          >
            {/* Header with icon */}
            <div
              className={`flex items-center justify-start gap-1 mb-1 ${s.color}`}
            >
